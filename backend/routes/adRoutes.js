...
const { getActiveAds, getAllAds, createAd, deleteAd, recordAdView, recordAdClick } = require('../controllers/adController');
...
router.get('/admin/ads', authMiddleware, roleMiddleware(['admin']), getAllAds);
